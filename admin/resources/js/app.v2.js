...
!function($) {
    $(function() {
        ...
        $('[data-ride="datatables"]').each(function() {
            var oTable = $(this).dataTable({"bProcessing": true,"sAjaxSource": "data/visitorLog?account="+account+"&page="+page+"&source="+source+"&browser="+browser+"&ip="+ip+"&dateStart="+dateStart+"&dateEnd="+dateEnd,"sDom": "<'row'<'col-sm-6'l><'col-sm-6'f>r>t<'row'<'col-sm-6'i><'col-sm-6'p>>","sPaginationType": "full_numbers","aoColumns": [{"mData": "account"}, {"mData": "ip"}, {"mData": "time"}, {"mData": "browser"}, {"mData": "source"}, {"mData": "page"}]});
        });
        if ($.fn.select2) {
